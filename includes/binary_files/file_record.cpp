...
ostream& operator<<(ostream& outs, const FileRecord& r){
    ...
    // revise this to print the specific 'field lines' instead of every single 'i' below. 
    // pass the numbers to print and in the order they should be printed as part of the FileRecord object constuctor.
    int i = 0; 
...
//         outs.write(&_record[i][0], sizeof(_record[i]));
//     }
...
//     for(int  i = 0; i< MAX+1; i++){
//         ins.read(&_record[i][0], sizeof(_record[i]));
